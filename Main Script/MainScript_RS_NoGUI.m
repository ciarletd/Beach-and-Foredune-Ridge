...
%This script is designed without an interface, with all inputs to be
...
Lc=200; %m Width required to nucleate a new dune 
Ls=5; %m Foredune setback distance
Qd=1.5; %m3/m/yr Foredune Flux
G1=0.065; %m/m Slope of dune flank 1
G2=0.065; %m/m Slope of dune flank 2
a=0.001; %rate of sea level rise in m/yr
H=0; %set starting height of dune
Qs=15; %m3/m/yr Shoreface Flux
...
DepthVector=NaN(1,n); %Volume units stored to beach
...
if speccond==1
%alternate form of dune growth/erosion can be activated here
end
